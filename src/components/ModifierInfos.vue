<template>
    <div>
        ...
        <div id="d1" style="display:none" class="formulaire1">
            <font size="2">(don't fill the one you don't want to change)</font>
            <br>
            New username :
            ...
            change_info(Username,Email) {
                ...
                .then(reponse => {
                    ...
                    if(Email != '') {
                        ...
                        user.email = reponse.data.data.attributes.email
                    }
                    if (Username != '') {
                        user.username = Username
                    } else {
                        user.username = reponse.data.data.attributes.username
                    }
